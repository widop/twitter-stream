...
use Widop\Twitter\Rest\ControlStreamRemoveUserRequest;
 ...
 */
class ControlStreamRemoveUserRequestTest extends \PHPUnit_Framework_TestCase
{
    /** @var \Widop\Twitter\Rest\ControlStreamRemoveUserRequest */
    private $request;
    ...
    {
        $this->request = new ControlStreamRemoveUserRequest('foo', '123456');
    }
    ...
    public function testOAuthRequestWithParameters()
    {
        ...
        $this->assertSame('/site/c/:stream_id/remove_user.json', $oauthRequest->getPath());
        $this->assertSame('POST', $oauthRequest->getMethod());
        $this->assertSame(
            'https://stream.twitter.com/1.1/site/c/foo/remove_user.json',
